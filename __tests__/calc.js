...
test.skip('the sum of 1 and 3 is 4', () => {
...
// Lesson 4.4
test.skip('the sum of 3 and "3" is 6', () => {
  const actual = calc.add(3, '3');
  const expected = 6;
  expect(actual).toBe(expected);
});

test.skip('the sum of 3 and "name" is false', () => {
  const actual = calc.add(3, 'name');
  const expected = false;
  expect(actual).toBe(expected);
});

test.skip('the sum of 3.14 and 5 is 8.14', () => {
...
test.skip('calculates the difference of 35 and 3 is 32', () => {
...
test.skip('calculates the quotient of 13 and 2 is 6.5', () => {
